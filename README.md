<style>h1::first-letter{color:orange;} h1>a:hover {display: inline-block; transform: rotate(180deg); text-decoration: unset;} h1>a::first-letter{color:orange;} table {font-size: .8em; line-height:1.05em;}</style>
