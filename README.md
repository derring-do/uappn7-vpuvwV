<style>h1>a {color:black; } h1::first-letter{text-decoration: overline;} h1>a:hover {display: inline-block; transform: rotate(180deg); text-decoration: unset;} h1>a::first-letter{text-decoration: overline;} table {font-size: .8em; line-height:1.05em;}</style>
